        ...
        <div class="row">
            <div class="col">
                <form action="guardar.php" method="POST">
                    ...
                    <button type="submit" id=boton class="btn btn-primary">ingresarlo con ajax</button>

                    <div class="input-group mb-2">
                    
                        <span class="input-group-text" id="basic-addon1">NOMBRE</span>
                        <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nissan" aria-label="Username"
